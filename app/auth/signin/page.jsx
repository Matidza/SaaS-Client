        ...
        try {
            ...
            if (response.ok && result.success) {
                ...
                if (result.user_type === "mentee") {
                    // if user is new or just looged In for the first time, the create profile page
                    // sholud pop-up to fill the form while loading the the dashboard page in the 
                    // background waiting for the create page to be filled.
                    // and after that, no need to redirect to create profile
